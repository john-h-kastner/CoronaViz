...
var cumulativeAnimation = true;//document.getElementById("cumulative_animation").checked;
...
var newsLayer = new NewsStandDataLayer(newsDataSelected,
    ...
    function() {
        ...
        var url = "https://newsstand.umiacs.umd.edu/coronaviz/il_query";
...
var twitterLayer = {plotData: function(){return;}, updateLayer: function(){return;}};
